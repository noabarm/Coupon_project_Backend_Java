...
public class CustomerFacade extends ClientFacade {
     ...
     * @throws SQLException SQLException this exception provides information on a database access error or other errors
     ...
     * @throws CouponAlreadyPurchasedException this exception will be thrown when customer try to purchase coupon
     *                                         that already purchase
     * @throws SQLException                    SQLException this exception provides information on a database access error or other errors
     *                                         and provides several kinds of information.
     */
